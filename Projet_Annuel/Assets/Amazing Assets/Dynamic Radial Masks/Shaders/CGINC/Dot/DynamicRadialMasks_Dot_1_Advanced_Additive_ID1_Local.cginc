#define DynamicRadialMasks_DOT_1_ADVANCED_ADDITIVE_ID1_LOCAL_LOOP_COUNT 1


float4 DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_Position[DynamicRadialMasks_DOT_1_ADVANCED_ADDITIVE_ID1_LOCAL_LOOP_COUNT];	
float  DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_Radius[DynamicRadialMasks_DOT_1_ADVANCED_ADDITIVE_ID1_LOCAL_LOOP_COUNT];
float  DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_Intensity[DynamicRadialMasks_DOT_1_ADVANCED_ADDITIVE_ID1_LOCAL_LOOP_COUNT];
float  DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_NoiseStrength[DynamicRadialMasks_DOT_1_ADVANCED_ADDITIVE_ID1_LOCAL_LOOP_COUNT];
