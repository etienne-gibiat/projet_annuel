Shader "Custom/Lit DRM"
{
    Properties
    {
        ...
        [Toggle] _InvertMask("InvertMask", Float) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Amazing Assets/Dynamic Radial Masks/Shaders/CGINC/HeightField/DynamicRadialMasks_HeightField_1_Advanced_Normalized_ID1_Local.cginc"
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                float mask = DynamicRadialMasks_HeightField_1_Advanced_Normalized_ID1_Local(input.positionWSAndFogFactor.xyz, 0);
