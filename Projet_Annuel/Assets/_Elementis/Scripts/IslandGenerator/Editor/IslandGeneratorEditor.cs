...
namespace _Elementis.Scripts.IslandGenerator
{
    ...
    public class IslandGeneratorEditor : Editor {
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                var script = (IslandGenerator)target;
                ...
                EditorGUI.BeginChangeCheck();
                script.maxRadius = EditorGUILayout.IntSlider(maxRadiusContent, script.maxRadius, 1, 200);
                if (EditorGUI.EndChangeCheck())
                {
