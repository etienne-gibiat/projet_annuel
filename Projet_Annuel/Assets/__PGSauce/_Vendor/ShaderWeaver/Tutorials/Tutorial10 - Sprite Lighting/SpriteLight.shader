...
Shader "Shader Weaver/SpriteLight"{   
	...
	SubShader {   
		Tags {
			...
			CGPROGRAM  
			#pragma surface surf Standard vertex:vert  nofog nolightmap nodynlightmap keepalpha
