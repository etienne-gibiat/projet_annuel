namespace Dreamteck.Splines.Editor
{
    ...
    public class ComputerEditor : SplineEditorBase
    {
        ...
        private SerializedProperty isForUi;
        private SerializedProperty splineUIDreamTeckData;
        ...
        public ComputerEditor(SplineComputer[] splines, SerializedObject serializedObject, DreamteckSplinesEditor pathEditor) : base()
        {
            ...
            isForUi = this.serializedObject.FindProperty("isForUi");
            splineUIDreamTeckData = serializedObject.FindProperty("splineUIDreamTeckData");
        ...
        public override void DrawInspector()
        {
            ...
            EditorGUILayout.PropertyField(isForUi, new GUIContent("Is For Ui"));
            if (spline.isForUi)
            {
                EditorGUILayout.PropertyField(splineUIDreamTeckData, new GUIContent("Ui data"));
            }
