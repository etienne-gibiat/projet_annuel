...
namespace Dreamteck.Splines
{
    ...
    public partial class SplineComputer : MonoBehaviour
    {
        ...
        [HideInInspector] public bool isForUi;
        [HideInInspector] public SplineUIDreamTeckData splineUIDreamTeckData;
        ...
        private void RunUpdate(bool immediate = false)
        {
            if (isForUi)
            {
                transform.localScale = splineUIDreamTeckData.GetScale(this);
            }
