...
namespace Pinwheel.CsharpWizard
{
    public partial class ClassWizard : EditorWindow
    {
        ...
        {
            bool willShow = scriptType == ScriptType.MonoBehaviour || scriptType == ScriptType.Class || scriptType == ScriptType.Struct || scriptType == ScriptType.Interface;
        ...
        {
            showStaticAbstractSealed.target = scriptType == ScriptType.Class || scriptType == ScriptType.MonoBehaviour ? 1 : 0;
            ...
            if (showStaticAbstractSealed.value > 0)
            {
                ...
                else
                {
                    staticAbstractSealedSelectedValue = EditorCommon.ToggleGroup(
                        ...
                        "Sealed");
                    isStatic = false;
                    isAbstract = staticAbstractSealedSelectedValue == 1;
                    isSealed = staticAbstractSealedSelectedValue == 2;
                }
