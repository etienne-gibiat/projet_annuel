...
namespace HighlightPlus {
    ...
    public class HighlightProfileEditor : Editor {
        ...
        SerializedProperty targetFX, targetFXTexture, targetFXColor, targetFXRotationSpeed, targetFXInitialScale, targetFXEndScale, targetFXTransitionDuration, targetFXStayDuration, targetFXVisibility;
