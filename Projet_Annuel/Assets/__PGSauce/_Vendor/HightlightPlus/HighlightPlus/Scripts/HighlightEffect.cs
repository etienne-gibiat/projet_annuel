...
namespace HighlightPlus {
    ...
    public partial class HighlightEffect : MonoBehaviour {
        ...
        bool CheckOcclusion(Camera cam) {
            ...
            if (Time.time - occlusionCheckLastTime < seeThroughOccluderCheckInterval && Application.isPlaying) return lastOcclusionTestResult;
